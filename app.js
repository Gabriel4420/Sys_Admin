...
// Running the server
const run = async () => {
 await mongoose.connect('mongodb+srv://sys_juliana:Gabriel442018@cluster0-lpzif.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology:true })
